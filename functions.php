...
*/
function katy_archive_menu(){
	print "<ul id='archive-menu-list' class='archive-menu-list'>";
	wp_get_archives();
	print "</ul>";
}

/**
Generate a category menu
*/
function katy_category_menu(){
	print "<ul id='category-menu-list' class='category-menu-list'>";
	wp_list_categories(array("hide_empty" => false, "heirarchical" => false, "title_li" => ""));
	print "</ul>";	
}
